...
import (
	...
	"github.com/shield/shield/internal/defender/cc"
...
func TestDDoSConcurrentBurst(t *testing.T) {
	...
	ddos := NewDefender(true, 1000, 30000, 100, 150, true, log)
	ip := "192.168.1.1"
...
func TestDDoSConcurrentBurst300(t *testing.T) {
	...
	ddos := NewDefender(true, 1000, 30000, 100, 300, true, log)
	ip := "192.168.1.1"
...
func TestCCDetectorConcurrentBurst(t *testing.T) {
	log, _ := logger.New("warn", "json", "")
	cc := cc.NewDetector(true, 100, 60, true, log)
