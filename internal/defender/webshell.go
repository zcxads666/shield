...
func NewWebShellDetector(enabled bool, action string, log *logger.Logger) *WebShellDetector {
	w := &WebShellDetector{
		enabled: enabled,
		action:  action,
		logger:  log,
...
func (w *WebShellDetector) ReloadPatterns(patterns []string) {
...
func (w *WebShellDetector) InspectRequest(r *http.Request) (bool, string) {
	if !w.enabled {
		return false, ""
	}
...
func (w *WebShellDetector) InspectRequestWithBody(r *http.Request, bodyBytes []byte) (bool, string) {
	if !w.enabled {
		return false, ""
	}
...
func (w *WebShellDetector) checkMultipartBody(bodyBytes []byte, boundary string) (bool, string) {
...
func (w *WebShellDetector) checkFilename(filename string) (bool, string) {
...
func (w *WebShellDetector) checkContent(content string) (bool, string) {
	w.mu.RLock()
	patterns := w.patterns
	w.mu.RUnlock()
